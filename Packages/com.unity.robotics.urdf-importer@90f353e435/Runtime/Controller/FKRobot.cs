...
namespace Unity.Robotics.UrdfImporter.Control{
    public class FKRobot : MonoBehaviour
    {
        ...
        public Vector3 localEndEffectorPos; // Has to be in the right-hand coordinate system
        ...
        private Matrix4x4 endEffectorPositionMatrix;
        ...
        void Start() {
            ...
            dh.Add(new float[]{0f, 0f, 0f, 0f});                             // i = 1
            dh.Add(new float[]{(float)-Mathf.PI/2, 0.28481f, 0.00538f, 0f}); // i = 2
        ...
        public Vector3 FK(List<float> angles = null) {
            ...
            endEffectorPos = new Vector3(endEffectorPositionMatrix[1,4], endEffectorPositionMatrix[3,4], endEffectorPositionMatrix[0,4]);
