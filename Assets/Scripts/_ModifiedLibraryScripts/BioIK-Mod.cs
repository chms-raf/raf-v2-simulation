// This was modified in order to update the joint angles with the IK algorithm
// Trying to move the assignment outside of this script made the movement very delayed
...
// 				var joint = motion.Joint.Segment.Transform.gameObject.GetComponent<ArticulationBody>();
// 				// Debug.Log(joint.transform.position);
// 				var drive = joint.xDrive;
// 				switch (i) {
// 					case 0: drive.target = (float) Solution[i] * Mathf.Rad2Deg; break;
// 					case 1: drive.target = -(float) Solution[i] * Mathf.Rad2Deg; break;
// 					case 2: drive.target = -(float) Solution[i] * Mathf.Rad2Deg; break;
// 					case 3: drive.target = (float) Solution[i] * Mathf.Rad2Deg; break;
// 					case 4: drive.target = -(float) Solution[i] * Mathf.Rad2Deg; break;
// 					case 5: drive.target = (float) Solution[i] * Mathf.Rad2Deg; break;
// 				}
